...
class FlexiCubesGeometry():
    def __init__(
            self, grid_res=64, scale=2.0, device='cuda', 
    ...
    def render_mesh(self, mesh_v_nx3, mesh_f_fx3, camera_mv_bx4x4, resolution=256, hierarchical_mask=False, Kinv=None, H=None, W=None,):
        return_value = dict()
